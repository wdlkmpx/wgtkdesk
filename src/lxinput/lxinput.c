...
// these icons should be in the icon theme: input-mouse / input-keyboard
...
int main(int argc, char** argv)
{
    ...
    gtk_icon_theme_prepend_search_path(gtk_icon_theme_get_default(), PACKAGE_DATADIR "/lxinput");

    /* build the UI */
    builder = gtk_builder_new();

    puts (PACKAGE_DATADIR "/lxinput");
    gtk_builder_add_from_file( builder, PACKAGE_DATADIR "/lxinput/lxinput.ui", NULL );
