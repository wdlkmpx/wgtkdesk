...
void log_add (GtkWidget *w, const char *tag, gchar *str)
{
    w_gtk_text_view_append (w, tag, str);
    w_gtk_text_view_scroll_to_end (w);
}
...
int main(int argc, char *argv[])
{
    ...
    /* VPN server field */
    hbox_server = gtk_box_new (GTK_ORIENTATION_HORIZONTAL,2);
    ...
    entry_server = gtk_combo_box_text_new_with_entry();
    ...
    /* Login field */
    hbox_login = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 2);
    ...
    entry_login = gtk_combo_box_text_new_with_entry();    
    ...
    /* Password field */
    hbox_passwd = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 2);
    ...
    gtk_box_pack_start ( GTK_BOX( h_box ), radio_button_1, FALSE, FALSE, 0);
    gtk_box_pack_start ( GTK_BOX( h_box ), radio_button_2, FALSE, FALSE, 0);
    gtk_box_pack_start ( GTK_BOX( h_box ), radio_button_3, FALSE, FALSE, 0);
    gtk_box_pack_start(GTK_BOX(vbox1), h_box, FALSE, FALSE, 0);
   /* End Radio Buttons */
   
    /* Start/Stop/Close buttons */
    hbox_conn = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 2);
    gtk_box_set_homogeneous (GTK_BOX(hbox_conn), TRUE);
    gtk_box_pack_start(GTK_BOX(vbox1), hbox_conn, FALSE, FALSE, 0);

    button_start = w_gtk_button_new ("Connect", "gtk-connect", 
                                     G_CALLBACK(pptp_connect), &w);
    ...
    button_stop = w_gtk_button_new ("Disconnect", "gtk-disconnect",
                                    G_CALLBACK(pptp_disconnect), &w);
    ...
    button_close = w_gtk_button_new ("Close window", "gtk-close",
    ...
    /*tag_error = */ gtk_text_buffer_create_tag (buffer, tag_error, 
                        "foreground", "#C00000", NULL);
    /*tag_info  = */ gtk_text_buffer_create_tag (buffer, tag_info,
