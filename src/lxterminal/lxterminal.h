...
#define ACCEL_PATH_VIEW_ZOOMIN      "<LXTerminal>/View/ZoomIn"
#define ACCEL_PATH_VIEW_ZOOMOUT     "<LXTerminal>/View/ZoomOut"
#define ACCEL_PATH_VIEW_ZOOMRESET   "<LXTerminal>/View/ZoomReset"
