...
#define NEW_WINDOW_ACCEL_DEF   "<Control><Shift>n"
#define NEW_TAB_ACCEL_DEF      "<Control><Shift>t"
#define CLOSE_TAB_ACCEL_DEF    "<Control><Shift>w"
#define CLOSE_WINDOW_ACCEL_DEF "<Control><Shift>q"
#define COPY_ACCEL_DEF         "<Control><Shift>c"
#define PASTE_ACCEL_DEF        "<Control><Shift>v"
#define NAME_TAB_ACCEL_DEF     "<Control><Shift>i"
#define PREVIOUS_TAB_ACCEL_DEF "<Control>Page_Up"
#define NEXT_TAB_ACCEL_DEF     "<Control>Page_Down"
#define MOVE_TAB_LEFT_ACCEL_DEF  "<Control><Shift>Page_Up"
#define MOVE_TAB_RIGHT_ACCEL_DEF "<Control><Shift>Page_Down"
#define ZOOM_IN_ACCEL_DEF        "<Control>plus"
#define ZOOM_OUT_ACCEL_DEF       "<Control>minus"
#define ZOOM_RESET_ACCEL_DEF     "<Control>equal"
