...
int main(int argc, char** argv)
{
...
#ifdef ENABLE_NLS
    /* initialize gettext */
    bindtextdomain("isomaster", PACKAGE_LOCALEDIR);
    ...
    GBLbrowserPaned = gtk_paned_new (GTK_ORIENTATION_VERTICAL);
