...
void showPreferencesWindowCbk(GtkButton* button, gpointer data)
{
    ...
    main_vbox = gtk_dialog_get_content_area (GTK_DIALOG(prefWidgets.dialog));
    ...
    gtk_box_pack_start(GTK_BOX(main_vbox), prefWidgets.viewer, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start (GTK_BOX(main_vbox), prefWidgets.tempDir, 
        TRUE, TRUE, 0);
