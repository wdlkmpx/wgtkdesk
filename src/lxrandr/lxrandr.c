/*
 *      lxrandr.c - Easy-to-use XRandR GUI frontend
 *
...
static void show_about_dlg( gpointer parent )
{
    ...
    gtk_about_dialog_set_copyright ( (GtkAboutDialog*)about_dlg, "Copyright (C) 2008-2022" );
...
int main(int argc, char** argv)
{
    ...
    dlg = gtk_dialog_new ();
    gtk_window_set_title (GTK_WINDOW (dlg), _("LXRandR [Display Settings]"));
