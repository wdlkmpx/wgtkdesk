...
static void create_popup_menu (GtkAccelGroup * accel_group)
{
    ...
    menuitem_open = w_gtk_menuitem_new (&menuitem);
    // ----
    w_gtk_menuitem_new (&menuitem);
    // Show controls
    ...
    menuitem_quit = w_gtk_menuitem_new (&menuitem);
}
...
void create_menubar (GtkAccelGroup * accel_group)
{
    ...
    menuitem.accel_group = accel_group; /* 1 */
    menuitem_file = w_gtk_menuitem_new (&menuitem);
    ...
    menuitem.icon_name   = "gtk-open";
    menuitem.accel_str   = "<Control>o";
    menuitem_file_open = w_gtk_menuitem_new (&menuitem);

    // File -> Open Folder
    menuitem.parent_menu = menu_file;
    menuitem.label       = _("Open _Folder");
    menuitem.icon_name   = "folder";
    menuitem_file_open_folder = w_gtk_menuitem_new (&menuitem);
    ...
    menuitem_file_open_location = w_gtk_menuitem_new (&menuitem);
    ...
    menuitem_file_disc = w_gtk_menuitem_new (&menuitem);
    // File -> Disc -> Open Audio CD
    menuitem.parent_menu = menu_file_disc;
    menuitem.label       = _("Open _Audio CD");
    menuitem_file_open_acd = w_gtk_menuitem_new (&menuitem);
    // File -> Disc -> ------
    menuitem_file_open_sep1 = w_gtk_menuitem_new (&menuitem);
    // File -> Disc -> Open DVD With Menus
    menuitem.label       = _("Open DVD with _Menus");
    menuitem_file_open_dvdnav = w_gtk_menuitem_new (&menuitem);
    // File -> Disc -> Open DVD from Folder with Menus
    menuitem.label       = _("Open DVD from Folder with M_enus");
    menuitem_file_open_dvdnav_folder = w_gtk_menuitem_new (&menuitem);
    // File -> Disc -> Open DVD from ISO with Menus
    menuitem.label       = _("Open DVD from ISO with Me_nus");
    menuitem_file_open_dvdnav_iso = w_gtk_menuitem_new (&menuitem);
    // File -> Disc -> ------
    menuitem_file_open_sep2 = w_gtk_menuitem_new (&menuitem);
    // File -> Disc -> Open VCD
    menuitem.label       = _("Open _VCD");
    menuitem_file_open_vcd = w_gtk_menuitem_new (&menuitem);

    // File -> TV
    menuitem.parent_menu = menu_file;
    menuitem.submenu     = menu_file_tv;
    menuitem.label       = _("_TV");
    menuitem_file_tv = w_gtk_menuitem_new (&menuitem);
    // File -> TV -> Open Analog TV
    menuitem.parent_menu = menu_file_tv;
    menuitem.label       = _("Open _Analog TV");
    menuitem_file_open_atv = w_gtk_menuitem_new (&menuitem);
    // File -> TV -> Open Digital TV
    menuitem.parent_menu = menu_file_tv;
    menuitem.label       = _("Open _Digital TV");
    menuitem_file_open_dtv = w_gtk_menuitem_new (&menuitem);

    // File -> Open Recent
    menu_file_recent = w_gtk_recent_menu_new ("lxplayer", NULL);
    menuitem.parent_menu = menu_file;
    menuitem.submenu     = menu_file_recent ;
    menuitem.label       = _("Open _Recent")    ;
    menuitem_file_recent = w_gtk_menuitem_new (&menuitem);

    // File -> ------
    menuitem.parent_menu = menu_file;
    menuitem_file_sep2 = w_gtk_menuitem_new (&menuitem);
    ...
    menuitem.icon_name   = "gtk-quit";
    menuitem.accel_str   = "<Control>q";
    menuitem_file_quit = w_gtk_menuitem_new (&menuitem);

    // Menu Edit -----------------------------------
    menuitem.parent_menu = menubar;
    menuitem.submenu     = menu_edit;
    menuitem.label       = _("_Edit");
    menuitem_edit = w_gtk_menuitem_new (&menuitem);
    ...
    menuitem_edit_random = w_gtk_menuitem_new (&menuitem);
    ...
    menuitem_edit_loop = w_gtk_menuitem_new (&menuitem);

    // Edit -> Play Single Track from Playlist
    menuitem.parent_menu = menu_edit;
    menuitem.label       = _("P_lay Single Track from Playlist");
    menuitem.checkbox    = TRUE;
    menuitem_edit_play_single = w_gtk_menuitem_new (&menuitem);

    // Edit -> ------
    menuitem.parent_menu = menu_edit;
    menuitem_view_sep0 = w_gtk_menuitem_new (&menuitem);

    // Edit -> Switch Audio Track
    menuitem.parent_menu = menu_edit;
    menuitem.label       = _("S_witch Audio Track");
    menuitem_edit_switch_audio = w_gtk_menuitem_new (&menuitem);

    // Edit -> Set Audio
    menuitem.parent_menu = menu_edit;
    menuitem.label       = _("Set Audi_o");
    menuitem_edit_set_audiofile = w_gtk_menuitem_new (&menuitem);

    // Edit -> Select Audio Language
    menuitem.parent_menu = menu_edit;
    menuitem.label       = _("Select _Audio Language");
    menuitem_edit_select_audio_lang = w_gtk_menuitem_new (&menuitem);

    // Edit -> Set Subtitle
    menuitem.parent_menu = menu_edit;
    menuitem.label       = _("Set S_ubtitle");
    menuitem_edit_set_subtitle = w_gtk_menuitem_new (&menuitem);

    // Edit -> Select Subtitle Language
    menuitem.parent_menu = menu_edit;
    menuitem.label       = _("S_elect Subtitle Language");
    menuitem_edit_select_sub_lang = w_gtk_menuitem_new (&menuitem);
    ...
    menuitem_edit_take_screenshot = w_gtk_menuitem_new (&menuitem);

    // Edit -> ------
    menuitem.parent_menu = menu_edit;
    menuitem_edit_sep1 = w_gtk_menuitem_new (&menuitem);
    ...
    menuitem_edit_config = w_gtk_menuitem_new (&menuitem);

    // Menu View -----------------------------------
    menuitem.parent_menu = menubar;
    menuitem.submenu     = menu_view;
    menuitem.label       = _("_View");
    menuitem_view = w_gtk_menuitem_new (&menuitem);
    ...
    menuitem_view_controls = w_gtk_menuitem_new (&menuitem);

    // View -> ------
    menuitem_view_sep3 = w_gtk_menuitem_new (&menuitem);

    // View -> Video Picture Adjustments
    menuitem.label       = _("_Video Picture Adjustments");
    menuitem_view_advanced = w_gtk_menuitem_new (&menuitem);

    // Menu Help -----------------------------------
    menuitem.parent_menu = menubar;
    menuitem.submenu     = menu_help;
    menuitem.label       = _("_Help");
    menuitem_help = w_gtk_menuitem_new (&menuitem);

    // Help -> About
    menuitem.parent_menu = menu_help;
    menuitem.label       = _("_About");
    menuitem.icon_name   = "gtk-about";
    menuitem_help_about = w_gtk_menuitem_new (&menuitem);
}
